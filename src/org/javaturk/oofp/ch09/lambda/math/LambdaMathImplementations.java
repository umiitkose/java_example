...
public static void main(String[] args) {
		...
		java.lang.Math adder = (double arg1, double arg2) -> { return arg1 + arg2;};
		doMath(adder, 3, 5);
		
		java.lang.Math multiplier = (double arg1, double arg2) -> { return arg1 * arg2;};
		doMath(multiplier, 3, 5);
		
		java.lang.Math subtracter = (double arg1, double arg2) -> { return arg1 - arg2;};
		doMath(subtracter, 3, 5);
		
		java.lang.Math divider = (double arg1, double arg2) -> { return arg1 / arg2;};
		doMath(divider, 3, 5);
...
//		doMath((float arg1, float arg2) -> { return arg1 + arg2;}, 3, 5); // Types of the parameters must be exactly the same
		...
		java.lang.Math mod = (a, b) -> a % b;
		doMath(mod, 100, 3);
		
		java.lang.Math power = (double a, double b) -> {return java.lang.Math.pow(a, b);};
...
*/
	...
	/*public static void doMath(java.lang.Math math, double arg1, double arg2){
