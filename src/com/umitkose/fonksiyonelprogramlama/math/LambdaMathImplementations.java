package com.umitkose.fonksiyonelprogramlama.math;

public class LambdaMathImplementations {
    public static void main(String[] args) {

        Math adder = (double arg1, double arg2) -> {
            return arg1 + arg2;
        };

        doMath(adder, 3, 5);

        Math multiplier = (double arg1, double arg2) -> {
            return arg1 * arg2;
        };
        doMath(multiplier, 3, 5);

        Math subtracter = (double arg1, double arg2) -> {
            return arg1 - arg2;
        };
        doMath(subtracter, 3, 5);

        Math divider = (double arg1, double arg2) -> {
            return arg1 / arg2;
        };
        doMath(divider, 3, 5);
